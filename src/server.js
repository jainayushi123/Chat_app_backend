      ...
      try {
        const io = new Server(server, {
          cors: {
            ...
            origin: "https://chat-app-snowy-zeta.vercel.app",
            credentials: true,
          },
        });
        io.on("connection", (socket) => {
          ...
          socket.on("video_call_offer", (data) => {
            ...
            socket
              .to(recieverId)
              .emit("video_call_offer", { from: callerId, offer });
          });
          ...
          socket.on("video_call_answer", (data) => {
            ...
            socket
              .to(callerId)
              .emit("video_call_answer", { to: callerId, answer });
          });
            ...
            if (timeToSend) {
              ...
              if (interval > 0) {
                socket.emit("status_changed", {
                  time: new Date(timeToSend).getTime(),
                  status: "Pending",
                });
                setTimeout(() => {
